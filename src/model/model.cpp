...
//
// NOTE: If you're curious about the strange parenthesisizing of std::min, it's because some other
//       header - possibly/supposedly windows.h - turns min/max into a macro, which is expanded if
//       the call is not parenthesisized
//
